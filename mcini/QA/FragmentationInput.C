void FragmentationInput(char* input_dirname, char* output_dirname, Int_t files, Int_t A, Int_t P_beam)
{
    ...
    fChain->Add(Form("%s/mcini_Au2_12AGeV_20k_withMST.root", input_dirname));

    TFile* ReadFile = new TFile("../input/Au2_12AGeV_20k_withMST.root");
    ...
    TH2F* hNprotons_vs_Nneutrons =              new TH2F("Nprotons_VS_Nneutrons",";N in fragment;Z in fragment",120,0,120,120,0,120);
    ...
    TH2F* hNnucl_vs_Nfrag_targ =          new TH2F("Nnucl_vs_Nfrag_proj",";Nfrag;Nnucl",30,0,30,90,0,90);
    ...
    TH2F* hEnergyE_vs_Nimf_proj =          new TH2F("EnergyE_VS_Nnucl_proj",";N_{IMF};E_{event}, GeV",15,0,15,35,0,3500);
    ...
    canvas->Print("../output/histos/Au2_12AGeV_20k_withMST.pdf(");
