...
TFile* ReadFile = new TFile("../dcmqgsm_in_aamcc_format_sps.root"); //pbpb158AGeV_20k_latest dcmqgsm_in_aamcc_format_sps
...
TLegend* leg2 = new TLegend(0.265,0.605,0.83,0.86,"DCM-QGSM");
leg2->AddEntry(charge_change,"hadronic", "lp");
