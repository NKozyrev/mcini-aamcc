...
nlines = ReadData("../PbCu_158A_GeV.dat", xVal, 1., yVal, 1.);
...
TLatex* sqrtS = new TLatex(4.5,12050, "PbCu, 158A GeV");
...
gPad->Print("biasedPbCu11MeV.png");
}
